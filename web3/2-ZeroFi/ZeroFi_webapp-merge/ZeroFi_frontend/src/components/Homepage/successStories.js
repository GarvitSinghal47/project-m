...
const SuccessStories = (props) => {
  ...
  const stories = [
    {
      id: 0,
      link: "https://medium.com/@decentralizedworld/ZeroFi-finance-helps-a-poor-indian-man-realize-his-dream-of-starting-his-own-food-truck-business-1ec259554df2",
      category: "Business",
      title:
        "ZeroFi Finance helps a poor Indian man realize his dream of starting his food truck business. ",
    ...
    {
      id: 2,
      link: "https://medium.com/@decentralizedworld/ZeroFi-finance-helps-a-boatman-turned-fisherman-to-secure-a-decent-income-for-his-family-during-7124ce5954a8",
      category: "Covid Affected",
      title:
        "ZeroFi finance helped a boatman turned fisherman to secure a decent income for his family during the entire lockdown. ",
      imgURL: "https://miro.medium.com/max/875/0*hsFuW3tpybj-xCpw",
      position: "top",
    },
    {
      id: 3,
      link: "https://medium.com/@decentralizedworld/a-young-mother-started-a-women-only-gym-with-the-help-of--finance-and-became-an-inspiration-86732b8483cd",
      category: "Women Empowerment",
      title:
        "A young mother started a women-only gym with the help of ZeroFi finance and became an inspiration for many. ",
