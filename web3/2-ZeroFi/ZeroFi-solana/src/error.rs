...
pub enum ZeroFiError {
    ...
    AmountOverflow,
    /// Account Not Owned By ZeroFi Program
    #[error("Account Not Owned By ZeroFi Program")]
    WrongAccountPassed,
    ...
    AdminDoesNotMatched,
    /// ZeroFi Vault Account Does Not Matched
    #[error("ZeroFi Vault Account Does Not Matched")]
    ZeroFiVaultAccountDoesNotMatched,
...
impl From<ZeroFiError> for ProgramError {
    fn from(e: ZeroFiError) -> Self {
